...
from GRUModel_tafeng import GRU_model
...
#model.load_state_dict(torch.load("best_100wei_tafeng.mdl"))#Load the last optimal parameter result and use it directly
