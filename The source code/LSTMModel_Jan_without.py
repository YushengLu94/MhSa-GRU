...
class GRU_model(nn.Module):
    def __init__(self, vector_size, hidden_size, num_layers, output_size):
        ...
        #embedding 操作
        self.embedding_work_product = nn.Embedding(45484, 500)
        self.embedding_work_category = nn.Embedding(482, 20)
        #self_attention操作
        #self.attention_product = selfattention(500, 1, 0.1)#10 50做 100坐 125 250
